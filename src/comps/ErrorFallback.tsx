...
function Fallback({ error, resetErrorBoundary }: FallbackProps) {
  ...
  return (
    <div className="ErrorFallback">
      ...
      <ol>
        <li>Try refreshing this page.  <button onClick={handleRefresh}>refresh</button></li>
        <li>If that didn't work, click this button to reset the settings. <button onClick={handleReset}>reset</button></li>
