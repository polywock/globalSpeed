...
import { DetailedHTMLProps, InputHTMLAttributes, TextareaHTMLAttributes, useCallback, useEffect, useMemo, useState } from "react"
...
export function ThrottledTextInput(props: ThrottledTextInputProps) {
	...
	env.sendUpdateDebounced = useCallback(
		debounce(
			(value: string) => {
